...
// Order statuses
function order_statuses($key = null, $type = null)
{
    if ($type == 'seller') {
        return \common\models\Orders::sellerStatusArray($key);
    } elseif ($type == 'command') {
        return \common\models\Orders::commandStatusArray($key);
    }

    return \common\models\Orders::statusArray($key);
}
