...
use app\models\search\LoadsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * LoadController implements the CRUD actions for Loads model.
 */
class LoadController extends Controller
{
    ...
    protected function findModel($id)
    {
        ...
        throw new NotFoundHttpException(Yii::t('loads', 'The requested page does not exist.'));
    }
}
