...
/**
 * UserDocumentController implements the CRUD actions for UserDocuments model.
 */
class UserDocumentController extends Controller
{
    ...
    /**
     * Creates a new UserDocuments model.
    ...
    /**
     * Updates an existing UserDocuments model.
    ...
    /**
     * Deletes an existing UserDocuments model.
    ...
    {
        if (($model = UserDocuments::findOne($id)) !== null) {
            return $model;
        }
