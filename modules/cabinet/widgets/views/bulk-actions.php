...
<div class="row">
    <div class="col-md-6 col-aligment-left">
        <?php if ($actions) : ?>
            <div class="btn-group col-in card-top-btn-actions">
                ...
                <?php if (in_array('publish', $actions)) : ?>
                    <button action-btn="publish" class="btn btn-light" data-toggle="tooltip" data-placement="bottom" title="<?= _e('Publish'); ?>">
                        <i class="ri-check-line"></i>
                    </button>
                <?php endif; ?>
                <?php if (in_array('unpublish', $actions)) : ?>
                    <button action-btn="unpublish" class="btn btn-light" data-toggle="tooltip" data-placement="bottom" title="<?= _e('Unpublish'); ?>">
        ...
        <?php if ($cities) : ?>
            <div class="btn-group col-in">
                ...
                <button type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?= _e('City'); ?> <i class="mdi mdi-chevron-down"></i>
                </button>
                <div class="dropdown-menu">
                    <?php
    ...
    <div class="col-md-6 col-aligment-right">
        <?php if ($show_clang) : ?>
            ...
            $current_content_lang = admin_content_lexicon(); ?>
